...
if page=="Home":
    ...
    st.info("For reproducible research, cite the exact dataset version. A DOI should be added after the GitHub release is archived in a DOI-issuing repository such as Zenodo.")
    ...
    st.code("Akhtar, M. A. K. (2026). HADIA-KB: Evidence-Linked Knowledge Base of Handia/Hadia/Haria (Version 1.0.0) [Data set].")
